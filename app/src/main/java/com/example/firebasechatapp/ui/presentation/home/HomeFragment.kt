...
import com.example.firebasechatapp.ui.presentation.home.viewModel.HomeViewModelImplementation
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class HomeFragment : BaseFragment<FragmentHomeBinding>() {
    private lateinit var adapter: ChatAdapter
    override val viewModel: HomeViewModelImplementation by viewModels()
